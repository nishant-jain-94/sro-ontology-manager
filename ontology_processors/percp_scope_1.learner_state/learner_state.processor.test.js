...
describe('Create conceptNodes from Stream', (done) => {
    ...
    it('Should create concept nodes from the stream', (done) => {
        ...
        highland([learner_state]).map(messageWrapper).pipe(learnerStateProcessor).collect().toArray((s) => {
            ...
            results[0].triples[0].source.properties.uniqueId.should.be.exactly('amishag');            
            ...
            results[0].triples[1].source.properties.uniqueId.should.be.exactly('amishag');            
            ...
            results[0].triples[2].source.properties.uniqueId.should.be.exactly('amishag');            
