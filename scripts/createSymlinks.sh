...
ln -sf $PWD/sro_utils $PWD/amqp_utils/sro_utils
ln -sf $PWD/sro_utils $PWD/ontology_broker/sro_utils
ln -sf $PWD/amqp_utils $PWD/ontology_broker/amqp_utils
...
do
    ln -sf $PWD/sro_utils $PWD/$processor/sro_utils
    ln -sf $PWD/neo4j_utils $PWD/$processor/neo4j_utils
    ln -sf $PWD/amqp_utils $PWD/$processor/amqp_utils
done

sudo ln -sf $PWD/sro_utils $PWD/neo4j_utils